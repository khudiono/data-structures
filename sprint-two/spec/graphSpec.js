describe('graph', function() {
  ...
  it('should have methods named "addNode", "contains", "removeNode", "addEdge", "hasEdge", "removeEdge", "forEachNode" and "addVertex"', function() {
  ...
  it('should add values to vertices', function() {
    graph.addVertex(1);
    expect(graph.vertices.includes(1)).to.equal(true);
  });
